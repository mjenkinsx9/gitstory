...
| 31 | **Best-of-N consistency** | Single prompt run | "Run this prompt N times. If outputs contradict each other, the inconsistency indicates hallucination — discard conflicting claims." |
